...
/**
 * Cluster Init analysis plugin class
 *
 ...
 * dataset in the data hierarchy viewer and choosing analyze >> cluster init analysis.
 ...
 * @author Y. Song
 */
class ClusterInitAnalysisPlugin : public AnalysisPlugin
{
Q_OBJECT
...
public:
     ...
     */
    ClusterInitAnalysisPlugin(const PluginFactory* factory);

    /** Destructor */
    ~ClusterInitAnalysisPlugin() override = default;
...
/**
 * Cluster init analysis plugin factory class
 *
 * Note: Factory does not need to be altered (merely responsible for generating new plugins when requested)
 */
class ClusterInitAnalysisPluginFactory : public AnalysisPluginFactory
{
    ...
    Q_PLUGIN_METADATA(IID   "nl.BioVault.ClusterInitAnalysisPlugin"
                      FILE  "ClusterInitAnalysisPlugin.json")

public:

    /** Default constructor */
    ClusterInitAnalysisPluginFactory() {}

    /** Destructor */
    ~ClusterInitAnalysisPluginFactory() override {}

    /** Creates an instance of the cluster init analysis plugin */
    AnalysisPlugin* produce() override;

    /** Returns the data types that are supported by the cluster init analysis plugin */
